<x-app-layout>
    ...
    <div class="bg-[#FFF8D4] py-4">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-wrap justify-between items-center gap-4">
                ...
                <div id="gridSort" class="flex items-center gap-2">
                ...
                <div id="tableSort" class="hidden flex items-center gap-2">
                    <span class="text-sm text-[#435663]">Sort by:</span>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg border border-gray-200">
                <div class="p-6 text-gray-900">
                  ...
                  <!-- Kachelansicht -->
                                      <div id="gridContainer" class="flex flex-wrap gap-6 justify-start">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // View-Modus aus localStorage lesen (Standard: grid)
            const currentView = localStorage.getItem('gamesViewMode') || 'grid';
            ...
            function setTableView() {
                ...
                localStorage.setItem('gamesViewMode', 'table');
            }

            gridBtn.addEventListener('click', function() {
                if (!gridBtn.disabled) setGridView();
            });

            tableBtn.addEventListener('click', function() {
                if (!tableBtn.disabled) setTableView();
            });

            // Initialer Zustand basierend auf localStorage
